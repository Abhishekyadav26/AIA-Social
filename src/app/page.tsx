  ...
  return (
      <main className="min-h-screen bg-base-950 flex flex-col items-center p-4">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold mb-8 text-neutral-200">FindMe <span className="text-green-600">Web3</span></h1>
...
{hasSearched && (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 w-full cursor-pointer">
        {isLoading ? (
