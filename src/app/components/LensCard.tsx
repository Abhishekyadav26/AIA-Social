  ...
  <div className="flex flex-col justify-between h-full p-4">
    <div>
      ...
      <div className="flex flex-row mt-2">
        ...
        <div className="flex flex-col">
          <h2 className="text-xl font-semibold">{profile.name || lensMetadata.handle || 'Unnamed Lens'}</h2>
    ...
    <div className="mt-4 w-full flex space-x-2">
      <a
        ...
        className="flex-1 text-white text-center items-center bg-green-500 hover:bg-green-600 hover:shadow-lg p-2 rounded-lg hover:shadow-green-500/50 transition-all duration-300"
      >
        View on Hey
      </a>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex-1 items-center text-center text-white bg-green-500 hover:bg-green-600 hover:shadow-lg p-2 rounded-lg hover:shadow-green-500/50 transition-all duration-300"
      >
        View on Orb
      </a>
    </div>
