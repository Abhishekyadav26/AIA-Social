  ...
  <div className="flex flex-col justify-between h-full p-4">
      ...
      <div className="flex flex-row mt-2">
        ...
        <div className="flex flex-col h-fit">
          ...
          <div className="flex items-center space-x-2">
            <span className="text-xs text-gray-500 border border-gray-500 rounded-lg px-2 py-1 inline-block">
    ...
    <div className="mt-4 w-full">
      <a
        ...
        className="flex-1 items-center text-white w-full bg-purple-500 hover:bg-purple-600 hover:shadow-lg p-2 rounded-lg hover:shadow-purple-500/50 transition-all duration-300"
      >
        View on Warpcast
      </a>
    </div>
